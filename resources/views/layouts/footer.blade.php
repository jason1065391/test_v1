    ...
    <footer>
        <div class="footer-content">
            <div class="footer-section about">
                <h2>關於我們</h2>
                <p>我們公司致力於提供高品質的教育服務，幫助學生找到最合適的教師。</p>
                <p>自成立以來，我們已經成功地幫助了數以萬計的學生和教師實現他們的學習目標。</p>
                <br>
                <p><strong>使命：</strong> 提供卓越的教育資源，促進學習和教學的發展。</p>
                <p><strong>願景：</strong> 成為全球領先的教育服務平台，推動教育公平和質量提升。</p>
            </div>
